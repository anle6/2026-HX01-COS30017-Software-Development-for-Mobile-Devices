...
object CarData {
    ...
    val cars = mutableListOf(
        Car(1, "Können", "Quarts R", 2013, 4.9f, 1200, 350, 
            ...
            "Engine: 5.0L V8\nHorsepower: 1140hp\nTop Speed: 440 km/h\n0-100 km/h: 2.8s"),
        Car(2, "Blair", "OP-3", 2013, 4.7f, 3400, 280, 
        ...
        Car(3, "Venstaior", "Poison SP", 2011, 4.8f, 5600, 310, 
        ...
        Car(4, "Können", "Sento Deadly Arrow", 2026, 5.0f, 100, 400, 
        ...
        Car(5, "Hollow", "IV Orange Snake", 2019, 4.6f, 8900, 250, 
    ...
    fun getCreditsSpent() = purchaseHistory.filter { it.type == "SPENT" }.sumOf { it.cost }
    fun getCreditsGained() = initialBalance
}
